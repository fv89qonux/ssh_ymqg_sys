...
import com.my.dzzw.service.BaseService;
...
public class  BaseServiceImpl<T> implements BaseService<T>{
	...
	public Pager<T> findPager(String hql, Object[] args,
			Map<String, Object> alias, Pager pager) {
		// TODO Auto-generated method stub
		return dao.findPager(hql, args, alias,pager);
	}

	@Override
	public Pager<T> findByPager(String hql, Map<String, Object> alias,
			Pager pager) {
		// TODO Auto-generated method stub
		return dao.findByPager(hql,alias,pager);
	}
