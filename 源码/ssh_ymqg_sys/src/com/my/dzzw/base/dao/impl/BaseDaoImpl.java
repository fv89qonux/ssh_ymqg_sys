package com.my.dzzw.base.dao.impl;
...
import com.my.dzzw.utils.SystemContext;
...
public class BaseDaoImpl<T> implements BaseDao<T> {
	...
	@SuppressWarnings("rawtypes")
	private void setNewPagers(Query query,Pager pages) {
		Integer pageSize = pages.getSize();
		Integer pageOffset = pages.getOffset();
//		if(pageOffset==null||pageOffset<0) pageOffset = 0;
//		if(pageSize==null||pageSize<0) pageSize = 15;
//		pages.setOffset(pageOffset);
//		pages.setSize(pageSize);
	...
	public Pager<T> findPager(String hql, Object[] args, Map<String, Object> alias,Pager pager) {
		hql = initSort(hql);
		String cq = getCountHql(hql,true);
		Query cquery = getSession().createQuery(cq);
		Query query = getSession().createQuery(hql);
	...
	public Pager<T> findByPager(String hql, Map<String, Object> alias,Pager pager) {
		return this.findPager(hql,null, alias,pager);
	}
